...
public final class FragmentMedicineBinding implements ViewBinding {
  ...
  private FragmentMedicineBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rvMedicine) {
  ...
  public static FragmentMedicineBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMedicineBinding((ConstraintLayout) rootView, rvMedicine);
    }
